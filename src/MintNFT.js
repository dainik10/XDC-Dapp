...
function MintNFT() {
  ...
  return (
    <Container className="mint-nft-container" maxWidth="lg">
      <Box sx={{ mt: 4, mb: 2 }}>
        <Typography className="nft-heading" variant="h4" align="center" gutterBottom>
          XDC NFT MINTING DAPP
        </Typography>
      </Box>
        ...
        <Grid item xs={12} md={6}>
          <Box mt={2}>
            <Button
              ...
              sx={{
                color: walletAddress ? undefined : "#fff",
              }}
            >
              {walletAddress
                ? "Wallet Connected"
                : "Connect Wallet to XDC Minting Dapp"}
            </Button>
          </Box>
          {walletAddress && (
            <Box mt={2}>
              ...
              <Typography align="center" color="#000">
                Wallet Balance: {walletBalance} TXDC
              </Typography>
            </Box>
          )}
          <TextField
          ...
          >
            <Alert
              ...
              sx={{ width: "100%" }}
            >
              NFT has been minted successfully!
            </Alert>
          </Snackbar>
        </Grid>
        <Grid item xs={12} md={6}>
          <Box
            ...
            sx={{
              ...
              background: imagePreviewUrl
                ? "none"
                : "linear-gradient(45deg, #887c7caf, #b3aeaea0)",
              backdropFilter: imagePreviewUrl ? "none" : "blur(20px)",
            }}
          >
            {imagePreviewUrl ? (
              <img
      ...
      <Box mt={4}>
        <Typography variant="h7" color="#000" align="center">
          Transaction History:
        </Typography>
        {transactionHistory.length > 0 ? (
          transactionHistory.map((hash, index) => (
            <Box key={index} mt={1} textAlign="left">
              <Link
                href={`https://explorer.apothem.network/tx/${hash}`}
                target="_blank"
          ...
          <Typography align="center" color="#000" mt={1}>
            No transactions yet.
          </Typography>
        )}
      </Box>
